...
class _GroceryPageState extends State<GroceryPage> {
  String listItem = "";
  String listTitle = "Grocery List";

  createGroceryList() {
    DocumentReference documentReference =
    Firestore.instance.collection('MyGroceryList').document(listItem);
  ...
  deleteGroceryList(item) {
    DocumentReference documentReference =
    Firestore.instance.collection('MyGroceryList').document(item);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: headerAppBar(context, titleText: 'GROCERY LIST'),
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: Firestore.instance.collection("MyGroceryList").snapshots(),
